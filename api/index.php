...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["ajax_pay"])) {
    ...
    $reference = "SPE-" . time() . "-" . rand(1000, 9999);
...
<div class="content">
  ...
  <div class="grid">
    ...
    <div class="card" data-amount="Ksh 45,000" data-fee="Ksh 5,000">
     ...
     <div class="card" data-amount="Ksh 70,000" data-fee="Ksh 7,000">
      <div class="check">✓</div><div class="amount">Ksh 70,000</div><div class="fee">Fee: Ksh 7,000</div>
    </div>
  </div>
